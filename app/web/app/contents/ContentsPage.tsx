...
export default function ContentsPage() {
  ...
  function applySearch(overrides: Partial<{ query: string; platform: string; accountType: string; direction: string; sellingPoint: string; page: number; pageSize: number }> = {}) {
