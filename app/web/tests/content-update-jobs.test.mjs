...
const bundle = await build({ entryPoints: [fileURLToPath(new URL("../app/contents/contentUpdateJobs.ts", import.meta.url))], bundle: true, write: false, platform: "node", format: "esm" });
