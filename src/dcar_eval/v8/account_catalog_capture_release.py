...
# Keep this versioned value stable: historical coverage binds its full hash.
# It describes one fixed rule, not a runtime mode or a time-limited override.
ACCOUNT_CATALOG_POLICY_V2 = {
    "contract": "account-catalog-automatic-capture-policy-v2",
    "statuses": ["daily", "weekly", "paused", "unmarked"],
    "operating_status_filter": "ignored",
    "identity": "unique_identity_with_verified_capture_evidence",
    "locator_required": True,
    "legacy_enabled_ignored": True,
    "legacy_membership_ignored": True,
    "pending_labels": "metadata_only",
}
ACCOUNT_CATALOG_POLICY_V3 = {
    **ACCOUNT_CATALOG_POLICY_V2,
    "contract": "account-catalog-automatic-capture-policy-v3",
    "platforms": ["douyin", "xiaohongshu", "kuaishou", "wechat_channels"],
    "new_platform_identity": "exact_full_profile_response",
    "account_preparation": "account-preparation-plan-v1",
}
ACCOUNT_CATALOG_POLICY = ACCOUNT_CATALOG_POLICY_V3
